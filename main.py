...
FACEBOOK_APP_ID = "375092569306818"
FACEBOOK_APP_SECRET = "df73c683449a39e37221a948bc74c2e5"
...
class PostToFBHandler(webapp2.RequestHandler):
    def post(self):
        ...
        if(content.get("id")):
           self.response.write('<script>alert("Your newly added status is now okay!");window.location.assign("/")</script>')
            ...
            self.response.write('<script>alert("Error Error Error");window.location.assign("/")</script>')
